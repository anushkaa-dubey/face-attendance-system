...
def detect_face(image_path):
    ...
    # IMPORTANT:
    # This is the preprocessing that worked in sanity_test.py
...
for person in sorted(os.listdir(TRAIN_DIR)):
    ...
    if embeddings:
        ...
        # Average all training embeddings
        person_embedding = torch.stack(
            embeddings
        ).mean(dim=0)

        person_embedding = F.normalize(
            person_embedding,
            p=2,
            dim=0
        )
...
print()
print("====================================")
print("MobileFaceNet Recognition Results")
print("====================================")
